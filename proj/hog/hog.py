...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    n = 3 * abs(player_score % 10 - opponent_score // 10 % 10)
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    turn_goal = make_averaged(roll_dice, samples_count)
    max1 = turn_goal(1, dice)
    result = 1
    for i in range(2, 11):
        max2 = turn_goal(i, dice)
        if max2 > max1:
            max1 = max2
            result = i
    return result
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    n = 3 * abs(score % 10 - opponent_score // 10 % 10)
    if n >= threshold:
        return 0
    else:
        return num_rolls
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    n = 3 * abs(score % 10 - opponent_score // 10 % 10)
    if sus_points(score + n) - score >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
